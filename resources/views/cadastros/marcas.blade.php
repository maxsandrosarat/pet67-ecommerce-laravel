                        ...
                        <td style="text-align: center;">
                            ...
                            <div class="modal fade" id="exampleModal{{$marca->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/admin/marcas/editar/{{$marca->id}}" method="POST">
                                            @csrf
                                            <div class="form-group">
                            ...
                            <a href="/admin/marcas/apagar/{{$marca->id}}" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Inativar"><i class="material-icons md-48">delete</i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
